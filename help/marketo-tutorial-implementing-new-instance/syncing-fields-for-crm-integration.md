...
* Kontrollera att Marketo Sync Profile har rätt behörighet för varje fält enligt ordlistan:
   ...
   * [Ange profilbehörigheter i veva](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/crm-sync/veeva-crm-sync/setup/step-2-of-3-create-a-veeva-crm-user-for-marketo-engage#set-profile-permissions){target="_blank"}
