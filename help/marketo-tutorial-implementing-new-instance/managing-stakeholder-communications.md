...
| **Frågor** | **Exempel** | **Hjälpmedel** |
| --- | --- | --- |
| Vilken intressent ska du fokusera på? | <ul><li>Försäljningschef</li><li>CMO</li><li>VD</li> |  |
| Vilka är era främsta mål (marknadsföring/försäljning/företag)? | <ol><li>Öka engagemanget med våra kunder och potentiella kunder</li><li>Skala upp verksamheten.</li> | <ul><li>[Läs om hur du utvecklar marknadsföringsmål och -strategi](https://experienceleague.adobe.com/sv/docs/marketo-learn/tutorials/fundamentals/goals-and-strategy-learn){target="_blank}</li><ul> |
| Hur ska Marketo Engage hjälpa er att uppnå dessa mål? | <ol><li>Vi kan skapa personaliserade program med hjälp av variabler, dynamiskt innehåll med mera</li><li> Vi kan skapa vårdsprogram som gör att vi kan upprätthålla ett långsiktigt engagemang med potentiella kunder och kunder</li><li>Vi kan automatisera våra marknadsföringsprogram för att nå fler människor med färre arbetstimmar i varje program.</li></ol> | <ul><li>[Varför automatisering är avgörande för alla marknadsföringsstrategier](https://business.adobe.com/se/blog/basics/5-benefits-marketing-automation){target="_blank}</li><li>[Tips om hur du skapar en marknadsföringsautomatiseringskarta](https://nation.marketo.com/t5/champion-program-blogs/tips-for-building-a-marketing-automation-roadmap/ba-p/325345){target="_blank}</li></ul> |
| Vilka potentiella hinder/hinder förutser ni under introduktionen och implementeringen som ledningsgruppen/aktieägaren ska vara medveten om? | <ol><li>Många anpassade objekt i CRM</li><li>Ingen tydligt definierad strategi för poäng för lead/person</li><li>Smutsiga data</li><li>Orealistiska tidslinjer och/eller förväntningar från ledningen</li><li>Komprimera projekt med resurser</li></ul> | <ul><li>[Nya implementeringstips för Marketo Engage](https://nation.marketo.com/t5/product-discussions/5-marketo-engage-new-implementation-tips/td-p/307788){target="_blank}</li><li>[Tips för nybörjare som implementerar och hanterar Marketo för första gången](https://nation.marketo.com/t5/product-discussions/tips-for-newbie-implementing-and-managing-marketo-for-the-first/m-p/174146#M124169){target="_blank}</li><li>[Tips från peer-datorer för introduktion av Adobe Marketo Engage](https://nation.marketo.com/t5/employee-blogs/top-10-tips-from-peers-for-onboarding-adobe-marketo-engage/ba-p/245098){target="_blank}</li></ul> |
...
Vi tackar <i>[TEAM]</i> för deras hjälp med <i>[CHALLENGE]</i>. För att kunna slutföra nästa steg i tid behöver vi <i>[FRÅGOR OM SHAREHOLDER]</i>.
