...
_Revolutionera datastrategin och ge teamet möjlighet att skapa ett enhetligt dokument för SDR (Solution Design Reference). Eliminera luckor i mätningen och främja en samverkansbaserad datakultur genom stegvisa metoder._

Det är äntligen dags. Du har samlat en heltäckande SDR En SDR är den guide du använder för att implementera mått och mått. Du har definierat vad de kallas, när de avfyrar, och dina utvecklare älskar det. Du gick igenom hela driftsättningsprocessen, skrev accepteringskriterier, gick igenom era sprintar, testade den och det är klart! Din instans av [!DNL Adobe Analytics] bör få marknadsförings- och produktteam att fira allt eftersom de fördjupar sig i informationen, få nya avslöjanden om dina kunder och hitta alla områden där det går bra och inte fungerar så bra. Men du hör inte de samtal du förväntade dig.
...
_Varför saknas i mätningen?_

_Varför tar inte dina teammedlemmar emot det här?_

Jag börjar med att släppa av dig lite. Det kommer _alltid_ att bli någon revision. Om er webbplats eller tillämpning är tillräckligt komplex för att behöva en företagsanalyslösning är det garanterat så att ni missar något. Men i det här fallet missade du inte tillräckligt för att förklara mätbristerna jag beskriver.
...
Jag vill gå igenom en metod som mina kollegor och jag har utvecklat för att både skapa en bättre SDR med färre luckor och få slutanvändarna att investera (och till och med ibland entusiastiska) i sin nya instans av [!DNL Adobe Analytics]. Låt oss gå igenom hur och varför du bör överväga den här metoden.

## Hur

_Lär dig mer om mätkonferensen. Använd en trattmappning för att visualisera varje steg i planen. Skapa dummypaneler som kan granskas som en grupp. Skapa en dataordlista för användare._
...
1. I början av varje tratt skriver du de rapporter som finns på kontrollpanelen och som produktchefen kan använda för att spåra prestandan. Dessa rapporter innehåller en [utfallsrapport](https://experienceleague.adobe.com/sv/docs/analytics/analyze/analysis-workspace/visualizations/fallout/fallout-flow), [aktuell månad](https://experienceleague.adobe.com/sv/docs/analytics/analyze/analysis-workspace/components/calendar-date-ranges/custom-date-ranges), [trender för konverteringsgrader](https://experienceleague.adobe.com/sv/docs/analytics/analyze/analysis-workspace/visualizations/line) och annat som är mer specifikt för den tratten.
...
1. Det ska finnas en övergripande vy, till exempel en [instrumentpanel för sammanfattning](driving-success-with-executive-summary-dashboards.md), och instrumentpaneler för varje funktion.
...
_Lär dig mer om att samla in krav, bygga upp en datakultur, få djupare insikter om data, skapa en känsla av ägarskap om data och förenkla data._
